...
public final class InputValidationUtil {
	...
	public static @Nullable String cleanToNull(@Nullable String text) {
	 ...
	 * </p>
	 */
	public static String removeUnprintableControlCharacters(String input) {
