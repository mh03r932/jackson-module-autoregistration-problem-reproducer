...
public final class DateUtil {
	...
	/**
	 * Gibt ein DateRange zurück, wenn gueltigAb gesetzt ist, sonst Optional.empty()
	 *
	 ...
	 * @return Gibt ein DateRange zurück, wenn gueltigAb gesetzt ist, sonst Optional.empty()
	 */
